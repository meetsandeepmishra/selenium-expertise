...
public class Simple_ELTC_010_CourseCatalogSearch {
  ...
  public void CourseCatalogSearchFunction() throws InterruptedException {
	  ...
	  loginPOM.sendPassword("Test@12");
	  loginPOM.clickLoginBtn();
	  screenShot.captureScreenShot("CourseCatalogPage");
	  Thread.sleep(2000);
	  courseCatalogPOM.clickCourseCatalog();
	  courseCatalogPOM.searchTextEnter("Selenium");
	  screenShot.captureScreenShot("CourseCatalogSearchPage");
	  courseCatalogPOM.clickSearchBtn();
	  courseCatalogPOM.validateSearchResult();
	  screenShot.captureScreenShot("CourseCatalogResultsPage");
  }
